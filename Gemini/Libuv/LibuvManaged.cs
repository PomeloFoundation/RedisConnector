  ...
  static  class LibuvManaged
    {
        ...
        [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int uv_handle_size(LibuvHandle.HandleType type);
        ...
        [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
        internal unsafe extern static int uv_try_write(IntPtr handle, LibuvBuffer.Windows* buffersList, int bufferCount);

        [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
        internal unsafe extern static int uv_try_write(IntPtr handle, LibuvBuffer.Unix* buffersList, int bufferCount);
        ...
        internal unsafe static extern int uv_write_unix(IntPtr req, IntPtr handle, LibuvBuffer.Unix* bufferList, int bufferCount, handle_callback callback);

        [DllImport("libuv", EntryPoint = "uv_write", CallingConvention = CallingConvention.Cdecl)]
        internal unsafe static extern int uv_write_win(IntPtr req, IntPtr handle, LibuvBuffer.Windows* bufferList, int bufferCount, handle_callback callback);

        [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int uv_is_active(IntPtr handle);

        [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
        static extern LibuvHandle.HandleType uv_guess_handle(int fd);
        ...
        internal delegate void read_callback_unix(IntPtr stream, IntPtr size, ref LibuvBuffer.Unix buffer);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void read_callback_win(IntPtr stream, IntPtr size, ref LibuvBuffer.Windows buffer);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void alloc_callback_unix(IntPtr data, uint size, out LibuvBuffer.Unix buffer);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void alloc_callback_win(IntPtr data, uint size, out LibuvBuffer.Windows buffer);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    ...
    struct uv_handle_t
    {
        public IntPtr data;
        public IntPtr loop;
        public LibuvHandle.HandleType type;
